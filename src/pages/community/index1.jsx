...
const Banner = () => (
  <div className="w-full mt-16 flex justify-center">
    <div
      ...
      style={{
        background: `url('	https://cdn-together.hellohealthgroup.com/2024/08/1725005916_66d1805cab8b91.82475390') no-repeat center center`,
...
const UnderBanner = () => (
  <div className="w-full max-w-6xl bg-white p-4  shadow-lg flex items-center justify-between gap-x-4 ml-8.5">
    ...
    <div className="w-12 h-12 flex-shrink-0">
      <img
        src="https://img.icons8.com/?size=100&id=QaQ91qshYoBE&format=png&color=000000" // Thay bằng URL icon thật
        alt="Community Icon"
    ...
    <div className="flex-1">
      <h2 className="text-lg font-bold">Mẹ bầu</h2>
